...
Check that an address and key has been created for the ada provider. If not, see "Creating Addresses and Signing Keys" in [Preliminaries](preliminaries.mdx).
...
Check that an address and key has been created for the dollar provider. If not, see "Creating Addresses and Signing Keys" in [Preliminaries](preliminaries.mdx).
...
10. Select "Download as JSON", set the file name to "swap-contract.json", and store the file in this folder.
